...
function draw() {
  ...
  for (let star of stars) {
    star.axis3.stch( -cos(t*TWO_PI*2)/2000, -cos(t*TWO_PI*2)/2000)
    star.axis3.move( cos(t*TWO_PI*2)/2000, cos(t*TWO_PI*2)/2000)
    star.axis2.stch( cos(t*TWO_PI*2)/2000, cos(t*TWO_PI*2)/2000)
    star.show();
  }
