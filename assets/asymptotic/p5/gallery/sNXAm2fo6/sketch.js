...
function setup() {
  colorsASK = [
    color(127, 0, 249, 140), // electric violet 1
    color(233, 59, 202, 140), // fuchsia 1
    color(251, 204, 255, 140), // light pink 1
    color(255, 206, 194, 140), // peach 1
    color(255, 0, 40, 200), // red 1
    color(139, 121, 162, 140), // smokey lavender 1
    color(132, 80, 155, 140), // smokey plum 1
    color(114, 85, 131, 140), // smokey plum 2
    color(190, 63, 246, 140), // violet 1
    color(193, 154, 216, 140), // warm lavender 1
    color(164, 146, 200, 140), // warm lavender 2
    color(174, 135, 194, 140), // warm lavender 4    
  ];
...
//  newY = random(0, height);
  ...
  newAlpha = random(3, 7) * 32 * map(mouseY, 0, height, .2, 1);
