...
//  newY = random(0, height);
  newW = random(40, 160)* map(mouseX, 0, width, .2, 1);
  newH = random(40, 160)* map(mouseX, 0, width, .2, 1);
  ...
  let newShard = new Shard(mouseX, mouseY, newW, newH, newA, colorStroke, colorFill);
  newShard.show();
}
